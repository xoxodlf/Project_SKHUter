			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="form-group" align="center">
							<div class="radio">
                            <label>
                                <input type="radio" name="optionsRadios">지출
                            </label>
                            <label style="margin-left:30px;">
                                <input type="radio" name="optionsRadios">수입
                            </label>
                        </div>   
						<div class="clearfix"></div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-6 col-sm-6">
							<input type="password" class="form-control" id="repassword" name="repassword" placeholder="금액을 입력하세요" onkeyup="passwdCheck();" >
						</div>
