			...
			<tbody>
				...
				<tr>
					...
					<td colspan="2" align=center>
						<button type="button" id="replyAddBtn" class="btn btn-default" >등록</button>
					</td>
				</tr>
			</tbody>
			<tfoot id='replies'>
...
$('#hateBtn').on('click',(function() {
	...
	if(hateclass=='btn btn-default active'){
		...
		formObj.attr("action", "/board/boardDetail/uphateM");
		formObj.attr("method", "post");		
		formObj.submit();
	}
}));
...
$('.removeBtn').on('click',(function() {
	 ...
	 var link = $(this).prev();
		var form = link;
		var arr = [];
		form.attr("action", "/board/boardDetail/deleteM");
