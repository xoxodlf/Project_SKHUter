	...
	<div class="panel-body">
		...
		<div class="table-responsive">
			<form role="form" id="deleteForm"
				action="/board/boardList/deleteList" method="post">
				<!-- 게시판 테이블 구성 -->
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach items="${boardList}" var="boardDTO"
									...
									<tr>
										<c:if test="${login.status>=3}">
											<td><input class="checklist" type="checkbox" name="check" value="${boardDTO.boardNo}" /></td>
										</c:if>
			...
			<div class="search-box">
				<select name="searchType" id="searchType"
					class="form-control input-sm" style="display: inline; width: 9%">
					<option value="t"
				...
				<input type="search" class="form-control input-sm" name='keyword' id="keywordInput" value='${cri.keyword}' style="display: inline;">
