 ...
 * 아이디/비밀번호 찾기 모달페이지
 *
 * @파일명 : user/include/findPwModal.jsp
 * @작성자 : 이종윤
 * @작성일 : 2017. 9. 15.
-->
	...
	<div class="modal-dialog" style="width: 35%">
		...
		<div class="modal-content">
			...
			<div class="modal-header"
				...
				<h2 class="tabbable" style="font-weight: bolder; color: white; font-size: 20px; text-align: center;">회원 정보 찾기</h2>
			</div>
				...
				<div class="row">
					<div class="tabbable">
						...
						<ul class="nav nav-tabs">
							<li id="findPassword">
								<a href="#tab2" data-toggle="tab" style="color: black;">비밀번호 찾기</a>
							</li>
							<li id="newPassword">
								<a href="#tab3" data-toggle="tab">새 비밀번호 만들기</a>
							</li>
						</ul>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab2">
								<form action="/user/findPw">
									...
									<p style="text-align: center;">
										회원정보에 등록한 아이디, 이름과 휴대전화 번호를 입력해 주세요. <br> 
										새로운 비밀번호를 발급합니다.
									</p>
									<br>
									...
									<div class="form-group">
										...
										<div class="col-xs-7 col-sm-7">
											<input type="text" class="form-control onlyNumber" id="idForPw" name="id" placeholder="학번을 입력하세요" maxlength="9">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-7 col-sm-7 ">
											<input type="tel" class="form-control" id="phoneForPw" name="phone" placeholder="휴대폰 번호를 입력하세요" />
										</div>
										<div class="clearfix"></div>
									</div>
									...
									<div class="modal-footer">
										<div class="row">
											<div class="col-xs-2 col-xs-offset-4">
												<button type="submit" id="findPwBtn" class="btn btn-warning"
													style="width: 100%; font-size: 15px; font-weight: bold;">찾기</button>
											</div>
											<div class="col-xs-2">
							...
							<div class="tab-pane" id="tab3">
								<form action="/user/createNewPw">
									<br>
									<p style="text-align: center;">
										새롭게 사용할 비밀번호를 등록해주세요 <br>
									</p>
									<input type="hidden" id="newId" value=""> <br>
									...
									<div class="form-group">
										...
										<div class="col-xs-7 col-sm-7">
											<input type="password"
												...
												id="newSetPassword" name="password"
												placeholder="새롭게 사용할 비밀번호를 입력하세요" maxlength="30">
										</div>
										<div class="clearfix"></div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-7 col-sm-7">
											<input type="password" class="form-control"
												id="newRePassword" name="rePassword"
									...
									<div class="modal-footer">
										<div class="row">
											<div class="col-xs-2 col-xs-offset-4">
												<button type="submit" id="newPwBtn" class="btn btn-warning"
													style="width: 100%; font-size: 15px; font-weight: bold;">등록</button>
											</div>
											<div class="col-xs-2">
												<button type="button" class="btn btn-default"
													data-dismiss="modal"
